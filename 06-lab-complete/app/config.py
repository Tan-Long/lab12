...
class Settings:
    ...
    llm_model: str = field(default_factory=lambda: os.getenv("LLM_MODEL", "gemini-2.5-flash-lite"))
    ...
    def validate(self):
        ...
        if not self.gemini_api_key:
            logger.warning("GEMINI_API_KEY not set — travel agent will fail on /ask")
        return self
